...
const cheesydata = [
  {
    name: "CB1",
    image: "./images/burger/cheesy-1.png",
  },
  {
    name: "CB2",
    image: "./images/burger/cheesy-2.png",
  },
  {
    name: "CB3",
    image: "./images/burger/cheesy-3.png",
  },
  {
    name: "CB",
    image: "./images/burger/cheesy-4.png",
  },
  {
    name: "CB",
...
export default function Cheesy() {
    ...
    <div className="px-12">
      ...
      <div className=" flex flex-col items-center">
        <ul className="w-4/6 flex flex-wrap justify-center gap-10 lg:px-10 py-5">
          {cheesydata.map((menus) => (
            <CheesyList menus={menus} key={menus.image} />
          ))}
        </ul>
      </div>
    </div>
