...
const menusdata = [
  ...
  {
    name: "titan burger",
    image: "./images/burger/titan-1.png",
  },
  {
    name: "titan burger",
    image: "./images/burger/titan-2.png",
  },
  {
    name: "titan burger",
    image: "./images/burger/titan-3.png",
  },
  {
    name: "titan burger",
    image: "./images/burger/titan-4.png",
  },
  {
    name: "titan burger",
    image: "./images/burger/plant-1.png",
  },
  {
    name: "titan burger",
    image: "./images/burger/plant-2.png",
  },
];
    ...
    <div className="px-12">
      ...
      <div className=" flex flex-col items-center">
        <ul className="w-4/6 flex flex-wrap justify-center gap-10 lg:px-10 py-5">
          {menusdata.map((menus) => (
            <MenusList menus={menus} key={menus.image} />
          ))}
        </ul>
      </div>
    </div>
